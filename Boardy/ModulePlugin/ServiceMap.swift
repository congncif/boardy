...
///
/// A module publishes accessors on its service map instead of exporting board identifiers, so
/// callers navigate to a feature without knowing how it is built:
///
/// ```swift
/// motherboard.serviceMap.modCheckout.ioCart.activation.activate(with: cart)
/// ```
///
